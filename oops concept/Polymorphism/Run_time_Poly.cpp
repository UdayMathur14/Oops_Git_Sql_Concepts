...
int main(){
    ...
    // inherit toh kr rha tha animal ko toh barking aana chaiye tha but aapne uska same function apni hi class m likh ke function ko override kr diya , isko bolte h function overring 
